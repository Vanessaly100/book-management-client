    ...
    return (
        ...
        >
            <div className="flex gap-x-3 p-3 items-center">
                ...
                />
                {!collapsed && <p className="text-lg font-medium text-white transition-colors dark:text-slate-50">FinLib</p>}
            </div>
                        ...
                        {navbarLink.links.map((link) => (
                            ...
                            >
                                <link.icon
                                    size={22}
                                    // color="#FFB400"
                                    className="flex-shrink-0 text-ActionPurple hover:text-white"
                                />
