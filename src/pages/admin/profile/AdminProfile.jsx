...
const AdminProfile = () => {
  ...
  return (
    <div className="max-w-[70%] mx-auto mt-10 p-6 bg-white text-black dark:bg-darkMainCardBg dark:text-white dark:border-gray-400 border-ActionPurple border-1 rounded-xl shadow-md">
      <div className="flex flex-col items-center mb-6 relative">
        <img
          src={
            selectedImage
      ...
      {editing ? (
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-center pb-4">Welcome Admin, {user?.first_name}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-between">
            <div className="">
              <div className="pb-3 border-b border-b-gray-300">
                <span className=" font-bold">Email</span>
