...
const BookPage = () => {
 ...
 // ✅ Debounced filter change
  ...
  // ✅ Safely map books with category and author info
//   const mappedBooks = useMemo(() => {
//     return data.map((book) => {
//       const category = categories.find(cat => cat.id === book.category_id);
//       const author = authors.find(auth => auth.id === book.author_id);
//       return {
//         ...book,
    ...
    return (
      <img
        ...
        onError={(e) => {
          ...
          e.target.src = "https://cdn.pixabay.com/photo/2014/09/08/05/06/book-438935_1280.png";
        }}
      />
    );
  },
