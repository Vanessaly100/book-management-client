    ...
    <>
      <div>
        <div className="hidden md:block">
          {/* Main Header */}
          <div
            className="bg-white text-black h-28 pt-4 w-full flex justify-between items-center flex-col shadow z-20"
            id="main-header"
          >
            ...
            <header
              className={`my-bg w-full h-20 flex items-center justify-between px-8 relative`}
            >
              ...
              <div>
                ...
                {!user && (
                  <div className="flex gap-4">
                    <Link
                      to="/login"
                      className="text-sm text-ActionPurple font-semibold"
                    >
                      Login
                    </Link>
                    <Link
          ...
          {/* Sticky Header */}
          <div
            className={`bg-white h-24 w-full flex justify-between items-center flex-col shadow z-50 fixed transition-all duration-500 ${
              showStickyHeader ? "top-0" : "-top-24"
            }`}
          >
            <header
              className={`my-bg w-full h-full flex items-center justify-between px-8 relative z-50`}
            >
          ...
          {user && (
            <div
              className={`h-[20vh] fixed w-48 right-0 top-[115px] bg-black rounded-lg opacity-75 blur-1 z-10 flex justify-center items-center p-5 ${
            ...
            >
              <div className="h-full w-full bg-black flex flex-col-reverse items-center justify-center gap-2">
                <div
                  className="border h-1/2 w-full rounded-lg flex items-center justify-center gap-4 cursor-pointer"
        ...
        <div className="sticky top-0 left-0 h-20 z-20 flex md:hidden  bg-white ">
          <div className="relative justify-between items-center w-full">
            ...
            >
              <div className="flex flex-col justify-center items-center gap-6 p-4 pt-6 font-medium">
                <Link
                  to="/user/home"
